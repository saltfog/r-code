...
vehicles <- read.csv(unz("~/r-code/Practical Data Science CookBook/0246OS_Code & Data/Chapter02/code/vehicles.csv.zip", "vehicles.csv"), stringsAsFactors = F)

head(vehicles)

labels <- read.table("~/r-code/Practical Data Science CookBook/0246OS_Code & Data/Chapter02/code/varlabels.txt", sep = "-", header = FALSE)

labels <- do.call(rbind, strsplit(readLines("~/r-code/Practical Data Science CookBook/0246OS_Code & Data/Chapter02/code/varlabels.txt"), " - "))
head(labels)
