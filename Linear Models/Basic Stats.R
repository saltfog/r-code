...
# Scatter Plot
plot(data_2013$Months.Served, data_2013$Months.Enrolled)

# Fit lines
abline(lm(data_2013$Months.Served~data_2013$Months.Enrolled), col="red")
lines(lowess(data_2013$Months.Served,data_2013$Months.Enrolled), col="blue")

# Bivariate Analysis
plot(data_2013$Months.Enrolled)

# Bivariate Analysis without outliners
qqplot(data_2013$Months.Served, data_2013$Months.Enrolled)
